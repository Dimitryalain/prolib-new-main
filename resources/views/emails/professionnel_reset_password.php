...
<body>
    <div style="font-family: Arial, sans-serif;">
        ...
        <p><a href="{{ route('password.reset', ['token' => $token]) }}" style="background-color: #00B98E; color: #ffffff; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Réinitialiser votre mot de passe</a></p>
