                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Rendez-vous</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $countRDVP }}</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Clients</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$nombreVisiteursParProfessionnel}}</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                RENDEZ-VOUS HONORES </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$coubtRDVHonoreNotaire}}</div>
                                                </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                @if ($moyenneNotesParProfessionnel)
                                                    {{ number_format($moyenneNotesParProfessionnel->moyenne_notes, 1, '.', '') }} / 5
                                                @else
                                                    0.0 / 5
                                                @endif
                                            </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="chart-area">
                                        ...
                                        <canvas id="rdvChartForProfessional" width="400" height="200"></canvas>
...
<script>
    ...
    var monthsForProfessional = @json($monthsForProfessional);
    var countsForProfessional = @json($countsForProfessional);

    var ctx = document.getElementById('rdvChartForProfessional').getContext('2d');

    var myAreaChartForProfessional = new Chart(ctx, {
        type: 'line', // Utilisez 'line' pour une courbe lissée
        data: {
            labels: monthsForProfessional,
            datasets: [{
                label: 'Nombre de RDV pour le professionnel',
                data: countsForProfessional,
