...
<li class="nav-item">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
        <form action="{{ route('update_profilV') }}" method="POST" enctype="multipart/form-data">
                    {!! method_field('PUT') !!}
                    {{ csrf_field() }}
                <div class="">
                    <img src="{{ asset($visiteur->photo) }}">
                </div>
                <br>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nom" name="nom" value="{{ Auth::guard('visiteur')->user()->nom }}">
                </div>
                <div class="form-group">
                    <label for="prenom">Prénom :</label>
                    <input type="text" class="form-control" id="prenom" name="prenom" value="{{ Auth::guard('visiteur')->user()->prenom }}">
                </div>
                <div class="form-group">
                    <label for="telephone">Téléphone :</label>
                    <input type="tel" class="form-control" id="telephone" name="telephone" value="{{ Auth::guard('visiteur')->user()->telephone }}">
                </div>
                <div class="form-group">
                    <label for="email">Email :</label>
                    <input type="email" class="form-control" id="email" name="email" value="{{ Auth::guard('visiteur')->user()->email }}">
                </div>
