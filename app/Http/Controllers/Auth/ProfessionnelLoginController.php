...
class ProfessionnelLoginController extends Controller
{
    /*
    |--------------------------------------------------------------------------
    | Notaire Login Controller
    |--------------------------------------------------------------------------
    |
    ...
    */
     ...
     * @var string
     */
    protected $redirectTo = '/professionnels/dashboard';
    ...
    {
        $this->middleware('guest:professionnel')->except('logout');
    }
    ...
    {
        return auth()->guard('professionnels');
    }
}
